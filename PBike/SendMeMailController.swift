...
extension MapViewController: MFMailComposeViewControllerDelegate {
    ...
    @IBAction func ratingBtnPressed(_ sender: AnyObject) {
        ...
        guard let checkURL = URL(string: "http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?id=\(appID)&pageNumber=0&sortOrdering=2&type=Purple+Software&mt=8") else { return }
